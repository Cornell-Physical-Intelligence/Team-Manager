...
const allowedCases = [
    ...
    ['bracket.step', 'application/octet-stream'],
    ['bracket.STP', 'application/step'],
    ['gear.stl', 'model/stl'],
    ['mesh.STL', 'application/vnd.ms-pki.stl'],
    ['housing.3mf', 'model/3mf'],
    ['surface.iges', 'application/octet-stream'],
    ['surface.igs', 'application/octet-stream'],
    ['drawing.dxf', 'application/dxf'],
    ['assembly.dwg', 'application/acad'],
    ['parasolid.x_t', 'application/octet-stream'],
    ['parasolid.x_b', 'application/octet-stream'],
    ['acis.sat', 'application/octet-stream'],
    ['part.sldprt', 'application/octet-stream'],
    ['assembly.sldasm', 'application/octet-stream'],
    ['inventor.ipt', 'application/octet-stream'],
    ['freecad.fcstd', 'application/octet-stream'],
    ['fusion.f3d', 'application/octet-stream'],
    ['toolpath.gcode', 'text/plain'],
